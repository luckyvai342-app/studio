...
const MOCK_TOURNAMENTS: Tournament[] = [
  {
    ...
    description: 'The ultimate showdown for Free Fire legends.',
    entryFee: 50,
    totalPrize: 5000,
    status: 'open',
  ...
  },
  {
    ...
    description: 'Fast-paced Duo action under the stars.',
    entryFee: 30,
    totalPrize: 2000,
    status: 'open',
    startTime: '2024-05-21T20:00:00Z',
    maxPlayers: 24,
    joinedCount: 10,
    map: 'Purgatory',
    type: 'Duo',
    imageUrl: PlaceHolderImages.find(img => img.id === 'tournament-2')?.imageUrl || ''
  }
];
